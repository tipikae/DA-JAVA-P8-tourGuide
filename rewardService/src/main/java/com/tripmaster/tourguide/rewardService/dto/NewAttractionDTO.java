 ...
 *
 */
public class NewAttractionDTO extends NewLocationDTO {
	...
	public NewAttractionDTO() {
		
	}
	
	public NewAttractionDTO(UUID attractionId, String attractionName, String city, String state,
